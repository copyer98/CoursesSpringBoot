...
public class InforServiceImpl implements InforService {
    ...
    */
    ...
    public Map getUnitDetail(String unit_id) throws Exception{
        ...
        String [] video_ids;
        video_ids=unit_videoDao.getVideosByUnitNoPage(unit_id);
        if (video_ids==null){
        ...
        String [] office_ids=unit_officeDao.getOfficesByUnitNoPage(unit_id);
        if (office_ids==null){
        ...
        List<Teacher> teachers;
        teachers=teacherService.getTeachersByCourse(course);
        map.put("teachers",teachers);//存放教师信息
        ...
        for(String unitId:unit_ids){
            ...
            String [] videoIds=unit_videoDao.getVideosByUnitNoPage(unitId);
            if (videoIds==null){
        ...
        SortUtil.sortMaps(videos_chapter);
    ...
    */
    @Override
    public Map getCoursesByCourseGroup(String courseGroup_id) throws Exception{

        Map detail=new HashMap();
        CourseGroup courseGroup=courseGroupDao.queryCourseGroupById(courseGroup_id);
        detail.put("courseGroup",courseGroup);
