    ...
    function sucFun (data) {
      ...
      if(data.success){
        ...
        for(var i in data.data.offices){
          $('.information .stu').append('<li><a href="' + data.data.offices[i].fileUrl + '" title=""><i class="glyphicon glyphicon-list-alt"></i>&nbsp;&nbsp;' + data.data.offices[i].description + '</a></li>');
        }
        for(var x in data.data.knowledgePoints){
          $('.information .point').append('<li index="' + data.data.knowledgePoints[x].id + '" data-toggle="modal" data-target="#myModal"><a href="javastript:void(0);"  title="">' + data.data.knowledgePoints[x].content + '</a></li>');
        }
        ...
        for(var y in data.data.videos_chapter){
          ...
          $('.s-list ul').append('<li><div class="col-md-6"><a href="/single?id=' + data.data.videos_chapter[y].unit.id + '" title=""><img src="/pic/20180308134636349.jpg" /></a></div><div class="col-md-6 detail"><a href="/single?id=' + data.data.videos_chapter[y].unit.id + '" title="">' + data.data.videos_chapter[y].unit.number + '</a><p class="author">' + data.data.videos_chapter[y].unit.name + '</p><p class="views">' + data.data.videos_chapter[y].unit.content + '</p></div></li>');
        }
